    ...
    <nav style={{display: 'flex', gap: '15px', padding: '15px', background: '#dfe6e9', alignItems: 'center', flexWrap: 'wrap'}}>
      ...
      {can('access_quotes') && (
        <>
          ...
          <Link to="/pipeline" style={{textDecoration:'none', color:'#333'}}> Pipeline Ventas</Link>
        </>
      )}
      
      {can('access_projects') && <Link to="/proyectos" style={{textDecoration:'none', color:'#333'}}> Proyectos</Link>}
